class TodoItemsController < ApplicationController
  ...
  def index
    ...
    @number_of_completed_todos = TodoItem.count_total_todos
  end
  ...
  def create
    ...
    respond_to do |format|
      if @todo_item.save
#insert phrase "todo_items_url" after "redirect_to" instead of "@todo_item" so user is directed back to the index page after creating TodoItem instead of show page
